...
BOOL sInfoRowTapTimestamp = YES;   // popup alert; default ON via registerDefaults (UDKeyInfoRowTapTimestamp)
BOOL sInfoRowTapTimestampOverlay = NO;  // transient overlay; default OFF (UDKeyInfoRowTapTimestampOverlay)
